...
<https://github.com/ResearchObject/runcrate/pull/10>`_ and
another where `tests fail
<https://github.com/ResearchObject/runcrate/pull/11>`_.

Version release
```````````````

Every time a Pull Request is merged to `main` branch, the `deployment workflow
<https://github.com/ResearchObject/runcrate/blob/master/.github/workflows/version-bump-and-package.yml>`_
...
`Network plot
<https://github.com/ResearchObject/runcrate/network>`_.
...
`Discussion tab
<https://github.com/ResearchObject/runcrate/discussions>`_.
...
.. _.travis.yml: https://github.com/ResearchObject/runcrate/blob/latest/.travis.yml
.. _tox: https://tox.readthedocs.io/en/latest/
.. _Appveyor-CI: https://www.appveyor.com/
.. _tox.ini: https://github.com/ResearchObject/runcrate/blob/latest/tox.ini
.. _.appveyor.yml: https://github.com/ResearchObject/runcrate/blob/latest/.appveyor.yml
.. _.codacy.yaml: https://github.com/ResearchObject/runcrate/blob/latest/.codacy.yaml
.. _.codeclimate.yml: https://github.com/ResearchObject/runcrate/blob/latest/.codeclimate.yml
.. _Codacy: https://app.codacy.com/
.. _Code Climate: https://codeclimate.com/
.. _coverage: https://pypi.org/project/coverage/
.. _.coveragerc: https://github.com/ResearchObject/runcrate/blob/latest/.coveragerc
