...
You can use the ``runcrate`` as a template for your own
...
2. Where ever it says ``runcrate`` change it for the name of your project.
...
3. In ``setup.py`` rename :code:`jmct-runcrate` for the name your project will
have at PyPI. Usually this is the same as the name you decided above.

4. Replace ``runcrate`` to the name of the repository of your
